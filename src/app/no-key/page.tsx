    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <div className={styles.info}>
          <p>
            A simple app to keep track of personal flights. The motivation
          ...
          <p>
            This app is not connected to a database and{" "}
            <strong>will not</strong> store your API key. You can verify this
            for yourself on{" "}
            <Link
          ...
          <p>
            As Air Labs limits the number of free requests an account can make I
            can{"'"}t afford to use my key for everyone. As such, you can use
            this app with your own free Air Labs key.
          </p>
          <ol className={styles.steps}>
            ...
            <li>
              Paste it in the field below (You will need to do this every time
              you want to make a request as this app is not connected to a
              database, it remembers your flights by leveraging your browser
              {"'"}s local storage)
            </li>
          </ol>
        </div>
      ...
      <footer>
        <p>
          <small>
            ...
            free API provided by Air Labs. Most notable is the fact that the API
            will not show specific flights for specific dates. As such this app
            is piecing together multiple different end points to make a best
            guess.
          </small>
        </p>
        <p>
